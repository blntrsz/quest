...
- Apply the **unslop** ability to every doc this standard touches. That ability owns the slop-pattern catalog: AI vocabulary, filler, hedging, formatting tells.
...
Apply every item to any prose this standard covers. Item 1 applies only to document sets:
