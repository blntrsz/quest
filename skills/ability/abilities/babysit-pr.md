...
Babysit a pull request: fix everything outstanding, land the fixes, and bring the description up to date.
...
5. **Print the PR link.** Always end a babysit run by printing the PR's URL, even when nothing needed changing.
